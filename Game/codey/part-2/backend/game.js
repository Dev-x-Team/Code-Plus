class Level extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "platform",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/platform.png"
    );
    this.load.image(
      "snowflake",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/snowflake.png"
    );
    this.load.spritesheet(
      "campfire",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/campfire.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "codey",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/codey.png",
      { frameWidth: 72, frameHeight: 90 }
    );

    this.load.image(
      "bg1",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/mountain.png"
    );
    this.load.image(
      "bg2",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/trees.png"
    );
    this.load.image(
      "bg3",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/snowdunes.png"
    );
  }
  ...
  levelSetup() {
    ...
    this.physics.add.overlap(
      ...
      gameState.goal,
      function () {
        this.cameras.main.fade(800, 0, 0, 0, false, function (
          camera,
          progress
        ) {
          if (progress > 0.9) {
...
class Credits extends Phaser.Scene {
  ...
  preload() {
    this.load.spritesheet(
      "codey_sled",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Tundra/codey_sled.png",
