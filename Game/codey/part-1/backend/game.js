...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "cave",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Cave+Crisis/cave_background.png"
    );
    this.load.image(
      "platform",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Cave+Crisis/platform.png"
    );
    ...
    this.load.spritesheet(
      "snowman",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Cave+Crisis/snowman.png",
      { frameWidth: 50, frameHeight: 70 }
    );
    this.load.spritesheet(
      "exit",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Cave+Crisis/cave_exit.png",
