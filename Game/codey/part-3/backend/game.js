...
class JumpScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "platform",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Jump/platform.png"
    );
    this.load.image(
      "stripe",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Jump/stripe.png"
    );
    this.load.spritesheet(
      "codey",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-phaser/Codey+Jump/codey.png",
      {
        frameWidth: 72,
        frameHeight: 90,
      }
  ...
  update() {
    if (cursors.left.isDown) {
      ...
      player.flipX = true; // we want to apply a negative x velocity to go left on the screen
