...
function preload() {
  ...
  this.load.image(
    "bg",
    "https://s3.amazonaws.com/codecademy-content/projects/learn-phaser/cyoa/background.png"
  );
  this.load.image(
    "knight",
    "https://s3.amazonaws.com/codecademy-content/projects/learn-phaser/cyoa/knight.png"
  );
  this.load.image(
    "orc",
    "https://s3.amazonaws.com/codecademy-content/projects/learn-phaser/cyoa/orc.png"
  );
  this.load.image(
    "wizard",
    "https://s3.amazonaws.com/codecademy-content/projects/learn-phaser/cyoa/wizard.png"
  );
}
...
function displayPage(scene, page) {
  ...
  for (let i = 0; i < page.options.length; i++) {
    ...
    optionBox.on(
      ...
      function () {
        ...
        if (newPage !== undefined) {
          destroyPage();
          destroyPage(scene, fetchPage(newPage));
        }
      },
      { option }
    );
    ...
    optionBox.on(
      "pointerover",
      function () {
        this.optionBox.setStrokeStyle(2, oxffe014, 1);
